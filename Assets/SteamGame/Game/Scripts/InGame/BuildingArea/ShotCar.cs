...
namespace TechC
{
    public class ShotCar : MonoBehaviour
    {
        ...
        private void Lottery()
        {
            ...
            createPos = centerPosition.position + new Vector3(randomX, randomY, 0);
        ...
        private void CreateObj()
        {
            ...
            if (obj != null)
            {
                ...
                float randomX = Random.Range(-areaSize.x / 2, areaSize.x / 2);
                float randomY = Random.Range(-areaSize.y / 2, areaSize.y / 2);
                Vector3 randomPosition = centerPosition.position + new Vector3(randomX, randomY, 0);
        ...
        private void OnDrawGizmos()
        {
            ...
            Gizmos.DrawWireCube(centerPosition.position, new Vector3(areaSize.x, areaSize.y,0));
